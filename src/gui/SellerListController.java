...
public class SellerListController implements Initializable, DataChangeListener {
	...
	private void createDialogForm(Seller entity, String absoluteName, Stage parentStage) {
		try {
			...
			controller.subrscribeDataChangeListener(this);
	...
	private void removeEntity(Seller obj) {
		Optional<ButtonType> option = Alerts.showConfirmation("Deletion Confirmation", "Are you sure to delete ?");
		...
		if (option.get() == ButtonType.OK) {
			...
			try {
				departmentService.removeSeller(obj);
				updateTableView();
			} catch (DbIntegrityException e) {
				Alerts.showAlert("Error to delete department", "DB integrity exception error", e.getMessage(), AlertType.ERROR);
			}
